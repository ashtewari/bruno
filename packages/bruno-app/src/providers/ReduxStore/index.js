...
import { adHocHistoryMiddleware } from './middlewares/ad-hoc-history/middleware';
...
let middleware = [tasksMiddleware.middleware, draftDetectMiddleware, autosaveMiddleware, adHocHistoryMiddleware];
if (isDevEnv()) {
